            ...
            <div className='flex py-[41px] lg:py-[53px] justify-center gap-[15vw]'>
                <div className='align-middle'>
                    <div className="heading text-left">
                        ...
                        <h1 className='max-w-[400px]'>We not only help you to plan the drills for in person training, but you can set programs for each individual trainees to work on in other days.</h1>
                    </div>
                </div>
