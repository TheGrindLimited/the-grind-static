                    ...
                    <div className="grid gap-y-10 gap-x-4 sm:grid-cols-3 lg:grid-cols-5">
                        <div className="flex flex-col">
                            ...
                            <ul className="mt-12 flex items-center gap-8">
                                <li>
                                    <Link href="https://www.facebook.com/TheGrindapps" target="_blank">
                                ...
                                <li>
                                    <a href="https://www.instagram.com/thegrind_app/" target="_blank">
                                ...
                                <li>
                                    <Link href="https://www.linkedin.com/company/thegrind-app/" target="_blank">
